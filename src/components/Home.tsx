...
const Home: React.FC = () => {
    return (
        ...
        <section className="bg-[#0A192F] text-white py-16 px-8 flex flex-col md:flex-row items-center md:items-start">
            <div className="container mx-auto flex flex-col lg:flex-row items-center lg:items-start lg-justify-between">
                ...
                <div className="lg:w-1/2 order-1 lg:order-2 flex justify-center lg:justify-end">
                    <img src="/src/assets/bugs.avif" alt="" className="rounded-full border-4 border-higlight w-64 h-64 object-cover" />
                </div>
            </div>
        </section>
    );
