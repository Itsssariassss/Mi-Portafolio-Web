        ...
        <div>
            <header className="bg-[#0A192F] text-white fixed w-full z-50 shadow-lg">
                <nav className="container mx-auto px-3 py-1 flex justify-between items-center">
                    ...
                    {/* Lista de Navegación */}
                    <ul
                        className={`md:flex md:items-center md:gap-10 absolute md:static top-16 right-0 w-1/5 md:w-auto bg-[#0A192F] md:bg-transparent transition-all duration-300 ${isOpen ? 'block' : 'hidden'}`}
                    >
                        <li>
                ...
                <hr className="border-t border-[#64FFDA] opacity-30" />
            </header>
        </div>
    );
};
